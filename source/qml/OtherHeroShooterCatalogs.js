...
var tf2Heroes = [
    { key: "tf2-scout", name: "Scout", role: "tank", portrait: "../data/assets/games/tf2/scout.jpg" },
    { key: "tf2-soldier", name: "Soldier", role: "tank", portrait: "../data/assets/games/tf2/soldier.jpg" },
    { key: "tf2-pyro", name: "Pyro", role: "tank", portrait: "../data/assets/games/tf2/pyro.jpg" },
    { key: "tf2-demoman", name: "Demoman", role: "damage", portrait: "../data/assets/games/tf2/demoman.jpg" },
    { key: "tf2-heavy", name: "Heavy", role: "damage", portrait: "../data/assets/games/tf2/heavy.jpg" },
    { key: "tf2-engineer", name: "Engineer", role: "damage", portrait: "../data/assets/games/tf2/engineer.jpg" },
    { key: "tf2-medic", name: "Medic", role: "support", portrait: "../data/assets/games/tf2/medic.jpg" },
    { key: "tf2-sniper", name: "Sniper", role: "support", portrait: "../data/assets/games/tf2/sniper.jpg" },
    { key: "tf2-spy", name: "Spy", role: "support", portrait: "../data/assets/games/tf2/spy.jpg" }
]
...
var pvzHeroes = buildPvzHeroes()

function catalog(gameId, overwatchRows) {
    if (gameId === "tf2") {
        return {
            id: "tf2",
            name: "Team Fortress 2",
            groups: [
                { id: "tank", name: "Ofensiva" },
                { id: "damage", name: "Defensa" },
    ...
    if (gameId === "pvzgw2") {
        return {
            ...
            groups: [
                { id: "tank", name: "Plantas" },
                { id: "damage", name: "Zombis" }
            ],
            heroes: pvzHeroes
        }
    }
